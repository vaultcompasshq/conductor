...
The unified `conductor` CLI is published to npm at **`1.0.3`** (`@vaultcompass/conductor-*`, trusted-publisher OIDC). Tier 0 dogfood + PR drift gate complete ([CapitalCanvas PR #109](https://github.com/vaultcompasshq/CapitalCanvas/pull/109)); latest patches address CapitalCanvas extraction dogfood ([#29](https://github.com/vaultcompasshq/conductor/pull/29), [#32](https://github.com/vaultcompasshq/conductor/pull/32)). Stability policy: [docs/release/stability-policy.md](./docs/release/stability-policy.md).
